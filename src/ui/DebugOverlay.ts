...
export class DebugOverlay {
  ...
  public update(now = performance.now()): void {
    ...
    this.element.innerHTML = `
      <div class="title">TECHNICAL VERTICAL SLICE <span class="${healthy ? 'ok' : 'warn'}">T19C CANDIDATE</span></div>
      <div class="grid">
        ...
        <span class="muted">CPU kit last</span><span>${escapeHtml(last.cpuKitLast)}</span>
